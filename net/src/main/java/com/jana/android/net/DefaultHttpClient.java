...
import com.jana.android.utils.HttpDateTime;
...
public class DefaultHttpClient implements HttpClient {
    ...
    private RuntimeException mLeakedException = new IllegalStateException(
            "DefaultHttpClient created and never closed");
    /**
     * cURL logging configuration.
     */
    private volatile LoggingConfiguration curlConfiguration;

    private DefaultHttpClient(ClientConnectionManager ccm, HttpParams params) {
        this.delegate = new org.apache.http.impl.client.DefaultHttpClient(ccm,
                params) {
            @Override
    ...
    public void setHttpRequestRetryHandler(HttpRequestRetryHandler retryHandler) {
        ((org.apache.http.impl.client.DefaultHttpClient) this.delegate)
