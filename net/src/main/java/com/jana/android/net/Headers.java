...
public final class Headers {
    ...
    private final static String[] sHeaderNames = {TRANSFER_ENCODING,
            CONTENT_LEN, CONTENT_TYPE, CONTENT_ENCODING, CONN_DIRECTIVE,
            LOCATION, PROXY_CONNECTION, WWW_AUTHENTICATE, PROXY_AUTHENTICATE,
            CONTENT_DISPOSITION, ACCEPT_RANGES, EXPIRES, CACHE_CONTROL,
            LAST_MODIFIED, ETAG, SET_COOKIE, PRAGMA, REFRESH,
    ...
    public void getHeaders(HeaderCallback hcb) {
        ...
        for (int i = 0; i < extraLen; i++) {
            ...
            hcb.header(mExtraHeaderNames.get(i), mExtraHeaderValues.get(i));
        }
    }
