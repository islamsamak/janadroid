...
public interface IActivity {
    ...
    String ACTION_UPDATE_SCREEN = "com.jana.android.action_UPDATE_SCREEN";

    String EXTRA_REQUIRES_UPDATE_VIEW = "extra_requires_update_view";

    boolean onUpdateView(Intent intent);
