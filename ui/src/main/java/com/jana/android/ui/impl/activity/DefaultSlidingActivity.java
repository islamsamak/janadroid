...
import com.jana.android.ui.activity.AbstractSlidingActivity;
import com.jana.android.utils.Logger;

/**
 * @author islam
 */
public class DefaultSlidingActivity extends AbstractSlidingActivity implements
        ...
        alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, btnName,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        DefaultSlidingActivity.this.finish();
                    }
                });
